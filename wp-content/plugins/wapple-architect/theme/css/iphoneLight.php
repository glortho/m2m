...
.nav{height:48px;line-height:48px;text-align:center;background:url(<?php echo WP_PLUGIN_URL.'/'.get_wapl_plugin_base();?>/theme/images/iphoneLight/menuRight.png) no-repeat right top;}
