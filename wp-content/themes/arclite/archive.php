...
<div id="main-wrap1">
     ...
     <div class="col1">
      <div id="main-content">
       ...
       <?php if (have_posts()) : ?>
        ...
        <?php /* If this is a category archive */ if (is_category()) { ?>
         ...
         <h1 class="pagetitle">
			<?php 
				...
				$out = str_replace( "Best in Chow" , "<img src='http://mastomillers.com/wp-content/themes/arclite/images/medal-icons95.png' height='95' width='95' border='0' align='center'> Best in Chow" , $out ) ;
				printf( __('%s', 'arclite'), $out ); 
			?>
		</h1>
        ...
        <?php while (have_posts()) : the_post(); $content = ratingreplace() ; ?>

        <!-- post -->
        <div id="post-<?php the_ID(); ?>" <?php if (function_exists("post_class")) post_class(); else print 'class="post"'; ?>>

          <div class="post-header">
           <h3 class='post-title'><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link:','arclite'); echo ' '; the_title_attribute(); ?>"><?php
 ...
 ?></a></h3>
          ...
          <?php if(get_option('post_preview')=='excerpt') the_excerpt(); else echo $content ; ?>
