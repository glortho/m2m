...
<?php if(get_arclite_option('jquery')): ?>
 ...
 <?php wp_enqueue_script('app',get_bloginfo('template_url').'/js/app.js',array(),false,true); ?>
<?php endif; ?>
 ...
 <div id="page"<?php if(!is_page_template('page-nosidebar.php')) { echo ' class="with-sidebar'; if((get_arclite_option('threecol')) || (is_page_template('page-3col.php'))) echo ' and-secondary'; echo '"';  } ?>>
  ...
  <div id="header-wrap">
   <div id="header" class="block-content">
     <a href="http://www.c-ville.com/Article/Features/Entertainment/?z_Issue_ID=11801208113190199#blog" target='_blank' title="C-Ville Best of 2011 Best Local Blog"><img src="<?php bloginfo('template_url'); ?>/images/bestofcville2011.png" alt="C-Ville Best of 2011 Winner, Best Local Blog" style='position:absolute;top:12px;right:30px;z-index:100'/></a>
     <div id="pagetitle">
