     ...
     <div class="col1">
      ...
      <?php 
        ...
        <div id="post-<?php the_ID(); ?>" <?php if (function_exists("post_class")) post_class(); else print 'class="post"'; ?>>
           <?php if (!get_post_meta($post->ID, 'hide_title', true)): ?><h2><?php 
			...
			<p class="post-date">
              ...
              <div class="post-content clearfix">
    	       <?php echo $content ; //the_content(__('Read the rest of this entry &raquo;', 'arclite')); ?>
              </div>
              <?php wp_link_pages(array('before' => '<p><strong>Pages: </strong> ', 'after' => '</p>', 'next_or_number' => 'number')); ?>

				<div style="text-align: center; padding: 15px; margin: 5px 5px 30px 5px; border: 1px #666">
					<div style="font-size: 12pt; margin: 8px">Agree or disagree?</div>
					<?php if( function_exists('LIKEBOT_BUTTON') ) { LIKEBOT_BUTTON(); } ?>
				</div>
